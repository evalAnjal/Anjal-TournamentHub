      ...
      <main className="px-4 py-10 md:px-8">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <section className="grid gap-6 md:grid-cols-[1.1fr,1.9fr]">
            {/* USER INFO */}
            <div
              className={`rounded-xl border theme-border theme-bg-card p-6 space-y-5`}
            >
            ...
            <div className={`rounded-xl border theme-border theme-bg-card p-6`}>
              <div className="flex items-center justify-between mb-5">
                <h2 className={`text-sm font-medium theme-text`}>
                  Preferences
                </h2>
          ...
          <section>
            ...
            <div
              className={`rounded-xl border theme-border theme-bg-card p-6 space-y-4 text-sm`}
            >
          ...
          <section className="pt-2">
            <div
              className={`flex items-center justify-between rounded-xl theme-bg-card px-4 py-3 text-sm`}
            >
              <div>
