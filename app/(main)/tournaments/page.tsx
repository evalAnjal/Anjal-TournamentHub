...
const LIVE_TOURNAMENTS = [
  { id: 1, name: "Valorant Cup #1", game: "Valorant", players: "24 / 32", prize: "NPR 65,000", timeLeft: "2h 15m" },
  { id: 2, name: "Weekend Rush", game: "Apex Legends", players: "18 / 20", prize: "NPR 40,000", timeLeft: "45m" },
] as const;

const UPCOMING_TOURNAMENTS = [
  { id: 3, name: "Beginner 5v5 Cup", game: "Valorant", start: "Sat · 19:00 IST", prize: "NPR 25,000" },
  { id: 4, name: "Night Grind", game: "CS2", start: "Sun · 21:30 IST", prize: "NPR 30,000" },
  { id: 5, name: "Trios Showdown", game: "Apex Legends", start: "Mon · 18:00 IST", prize: "NPR 50,000" },
] as const;

const GAME_FILTERS = ["All", "Valorant", "CS2", "Apex Legends"] as const;
      ...
      <main className="px-4 py-8 md:px-8 md:py-10">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <header className="space-y-2">
            <p className="text-xs uppercase tracking-wide text-purple-400">Tournaments</p>
            <h1 className="text-2xl md:text-3xl font-semibold">Browse tournaments</h1>
            <p className="text-sm text-gray-400">
              Join live events or register for upcoming tournaments across your favourite games.
            </p>
          </header>

          {/* Filters */}
          <section className="flex flex-wrap items-center justify-between gap-3 text-xs" aria-label="Filters">
            ...
            <span className="text-[11px] text-gray-500">
              Showing {LIVE_TOURNAMENTS.length + UPCOMING_TOURNAMENTS.length} tournaments
            </span>
          </section>

          {/* Live tournaments */}
          <section className="space-y-3" aria-label="Live tournaments">
            ...
            {LIVE_TOURNAMENTS.length === 0 ? (
              <p className="text-xs text-gray-500 rounded-lg border border-gray-800 bg-[#0b0b11] px-4 py-4">
                No live tournaments at the moment. Check the upcoming section below.
              </p>
            ) : (
                ...
                {LIVE_TOURNAMENTS.map((t) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[11px] text-gray-500">{t.players} players</span>
                    </div>
          ...
          <section className="space-y-3" aria-label="Upcoming tournaments">
                ...
                >
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500">
                      {t.game} · <span className="text-gray-300">{t.start}</span>
                    </p>
                    <p className="text-[11px] text-amber-300">{t.prize} prize pool</p>
                  </div>
